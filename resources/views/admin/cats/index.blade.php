                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($cats as $cat)
                                            <tr>
                                                ...
                                                <td>
                                                    <button data-toggle="modal" data-id="{{ $cat->id }}"
                                                        data-name-en="{{ $cat->name('en') }}"
                                                        data-name-ar="{{ $cat->name('ar') }}" data-target="#modal-lg"
                                                        class="btn btn-sm btn-info edit-btn"><i
...
@section('scripts')
    <script>
        $('.edit-btn').click(function() {
            ...
            let nameEr = $(this).attr('data-name-en')
            let nameAr = $(this).attr('data-name-ar')
            console.log(id, nameAr, nameEr)
        })
    </script>
@endsection
